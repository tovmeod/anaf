...
from views import save_upload
from mail import EmailReceiver
from anaf.identities.models import Contact
from models import Object, UpdateRecord, Attachment
...
def email_reply():
    """Fetches emails"""
    from mail import IMAP_SERVER, EMAIL_USERNAME, EMAIL_PASSWORD
