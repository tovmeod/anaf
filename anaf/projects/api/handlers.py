...
from anaf.projects.models import Task, Project, Milestone, TaskStatus, TaskTimeSlot
from anaf.projects.forms import ProjectForm, TaskForm, MilestoneForm, TaskStatusForm, TaskTimeSlotForm
...
class TaskStatusHandler(ObjectHandler):
    ...
    def check_create_permission(self, request, mode):
        return request.user.profile.is_admin('anaf.projects')
