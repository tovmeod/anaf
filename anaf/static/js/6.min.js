...
// anaf.js
var anaf={put_mce:function(a){(a?$("textarea",a):$("textarea")).each(function(){$(this).hasClass("no-editor")||($(this).attr("id",a.attr("id")+"-"+$(this).attr("id")),$(this).hasClass("full-editor")?$(this).tinymce({script_url:"/static/js/tinymce/jscripts/tiny_mce/tiny_mce.js",theme:"advanced",skin:"cirkuit",relative_urls:!1,plugins:"safari,table,advhr,inlinepopups,insertdatetime,preview,searchreplace,contextmenu,paste,fullscreen,nonbreaking,visualchars,xhtmlxtras",theme_advanced_buttons1:"bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,formatselect,fontselect,fontsizeselect,|,cut,copy,paste,pastetext,pasteword,|,search,replace", theme_advanced_buttons2:"bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,image,cleanup,code,|,insertdate,inserttime,preview,|,forecolor,backcolor,|,cite,abbr,acronym,del,ins",theme_advanced_buttons3:"tablecontrols,|,hr,removeformat,|,sub,sup,|,visualchars,nonbreaking,charmap,advhr,|,fullscreen",theme_advanced_disable:"help,styleselect,anchor,newdocument",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:!0, theme_advanced_resize_horizontal:!0,theme_advanced_resizing_use_cookie:!0,theme_advanced_path:!1,width:"70%"}):$(this).tinymce({script_url:"/static/js/tinymce/jscripts/tiny_mce/tiny_mce.js",theme:"advanced",skin:"cirkuit",relative_urls:!1,plugins:"safari,table,advhr,inlinepopups,insertdatetime,preview,searchreplace,contextmenu,paste,fullscreen,nonbreaking,visualchars,xhtmlxtras",theme_advanced_statusbar_location:"bottom",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_path:!1, theme_advanced_resizing:!0,theme_advanced_resize_horizontal:!0,theme_advanced_resizing_use_cookie:!0,theme_advanced_disable:"justifyleft,justifycenter,justifyright,justifyfull,outdent,indent,image,help,hr,removeformat,formatselect,fontselect,fontsizeselect,styleselect,sub,sup,forecolor,backcolor,forecolorpicker,backcolorpicker,charmap,visualaid,anchor,newdocument,blockquote",theme_advanced_buttons1:"bold,italic,underline,strikethrough,|,undo,redo,|,cut,copy,paste,link,unlink,cleanup,|,bullist,numlist,|,code", theme_advanced_buttons2:"",theme_advanced_buttons3:"",width:"70%"}))})},remove_mce:function(a){(a?$("textarea",a):$("textarea")).each(function(){tinyMCE.execCommand("mceRemoveControl",!1,$(this).attr("id"))})},do_ajax:function(){var a=window.location.hash.replace(/#/gi,"");if(!a)a=window.location.pathname;var c=$('.menu-item a[href="#'+a+'"]');if(c.length&&!c.hasClass("active")&&(block=$("#module-"+c.attr("id").substring(5)),block.length))$(".module-block").each(function(){$(this).attr("id")!=block.attr("id")? ($(this).css("display","none"),$(this).data("active",!1)):(block.css("display","block"),block.data("active",!0))}),document.title=block.data("title"),$(".menu-item a").each(function(){$(this).removeClass("active")}),c.addClass("active"),a="";a&&(a=anaf.prepare_url(a),$("#loading-status").css("display","block"),$("#loading-status-text").html("Loading..."),$.ajax({url:a,dataType:"json",success:anaf.process_ajax,complete:anaf.process_html,error:anaf.show_error}))},show_error:function(){$("#loading-status-text").html("Something went wrong...")}, process_userblock:function(a){a.response.messages&&$("#userblock-messages").each(function(){$(this).html(a.response.messages)})},process_ajax:function(a){if(a)if(a.popup)anaf.process_popup_data(a);else if(a.redirect)window.location.hash=="#"+a.redirect?anaf.do_ajax():window.location.hash=a.redirect;else if(a.redirect_out)window.location=a.redirect_out;else{if(a.response.url){var c=a.response.url.replace(".ajax",""),b=window.location.hash.replace("#","");if(c!=b&&c.indexOf(b)==-1&&b.indexOf(c)== -1){$("#loading-status").css("display","none");return}}document.title=a.response.content.title;var c=a.response.content.module_content,b=a.response.modules.active,d="none";if($("#module-"+b).length==0)$("#content").append('<div class="module-block" id="module-'+b+'"></div>');else{var e=$("td.module-sidebar-right",$("#module-"+b));e&&(d=e.css("display"))}var f=$("#module-"+b);$(".module-block").each(function(){$(this).attr("id")!=f.attr("id")?($(this).css("display","none"),$(this).data("active",!1)): (f.css("display","block"),f.data("active",!0))});anaf.remove_mce($("#module-"+b+" form"));$("#module-"+b).html(c);$("#module-"+b+" form").length&&(anaf.prepare_forms(f),anaf.prepare_comments(f),$("#module-"+b+" textarea").length&&anaf.put_mce(f));anaf.prepare_tags(f);anaf.prepare_list_actions(f);anaf.prepare_popups(f);anaf.convert_links(f);anaf.prepare_ajax_links(f);anaf.prepare_slider_sidebar(f,d);anaf.showhidejs(f);anaf.prepare_module_stuff(b);anaf.process_notifications(a.response.notifications); $(".menu-item a").each(function(){$(this).removeClass("active")});anaf.process_userblock(a);$("#menu-"+b).addClass("active");$(f).data("title",a.response.content.title);$("#loading-splash").css("display")!="none"&&$("#loading-splash").fadeOut();$("#loading-status").css("display","none")}},process_notifications:function(a){for(var c in a){var b={title:" ",text:a[c].message,image:"/static/notifications/"+a[c].tags+".png"};if(a[c].title)b.title=a[c].title;if(a[c].image)b.image=a[c].image;$.gritter.add(b)}}, process_html:function(a,c){c=="parsererror"&&window.document.write(a.responseText)},prepare_module_stuff:function(a){try{anaf.modules[a].init()}catch(c){}},prepare_url:function(a){if(a.indexOf("!")!=-1||a.indexOf("?")!=-1)a=a.replace("!","?"),a.indexOf(".ajax")==-1&&(a=a.replace("?",".ajax?"));a.indexOf(".ajax")==-1&&(a+=".ajax?");return a},showhidejs:function(a){if(a)var c=$("div.showjs",a),a=$("div.hidejs",a);else c=$("div.showjs"),a=$("div.hidejs");c.each(function(){$(this).css("display","block")}); a.each(function(){$(this).css("display","none")})},convert_links:function(a){(a?$("a",a):$("a")).each(function(){if($(this).attr("href")&&!$(this).hasClass("ajax-link-out")&&!$(this).hasClass("ajax-link")&&!$(this).attr("target")&&$(this).attr("href").substring(0,3)!="www"&&$(this).attr("href").substring(0,5)!="http:"&&$(this).attr("href").substring(0,6)!="https:"&&$(this).attr("href").substring(0,4)!="ftp:"&&$(this).attr("href").substring(0,7)!="mailto:"&&$(this).attr("href").indexOf("#")==-1&&($(this).attr("href", "#"+$(this).attr("href").replace("?","!")),$.browser.msie&&$.browser.version.substr(0,1)<7)){var a=window.location.href.replace(window.location.hash,"");$(this).attr("href",$(this).attr("href").replace(a,""))}})},add_data:function(a){var c=$(a.target);a.inner?c.html(a.content):a.append?c.append(a.content):(a=$(a.content),c.replaceWith(a),c=a);$("form",c).length&&(anaf.prepare_forms(c),anaf.prepare_comments(c),$("textarea",c).length&&anaf.put_mce(c));anaf.prepare_tags(c);anaf.prepare_list_actions(c); anaf.prepare_popups(c);anaf.convert_links(c);anaf.prepare_ajax_links(c);anaf.showhidejs(c);$("#loading-status").css("display","none")},prepare_ajax_links:function(a){(a?$(".ajax-link",a):$(".ajax-link")).each(function(){$(this).click(function(){var a=$(this).parents($(this).attr("target")),b=anaf.utils.generate_id();a.attr("id",b);$(this).attr("target","#"+b);var a=eval($(this).attr("callback")),d=eval("("+$(this).attr("args")+")"),b=d?$.extend({target:"#"+b},d):{target:"#"+b}; $("#loading-status").css("display","block");$("#loading-status-text").html("Loading...");a(Dajax.process,b);return!1})})},prepare_slider_sidebar:function(a,c){a||(a=$(".module-block"));var b=$("<div></div>").addClass("sidebar-slider");$("td.module-content-inner",a).prepend(b);b.data("sidebar",$("td.module-sidebar-right",a));b.click(function(){var a=$(this).data("sidebar");a&&(a.css("display")=="none"?a.fadeIn():a.fadeOut())});var d=$("td.module-sidebar-right",a);($("a.projects-action",d).length!= 0||$("a.services-action",d).length!=0)&&b.append('<img src="/static/icons/sidebar/status.gif"/><br />');$("form.content-filter-form",d).length!=0&&b.append('<img src="/static/icons/sidebar/filter.gif"/><br />');$("div.permission-links",d).length!=0&&b.append('<img src="/static/icons/sidebar/permission.gif"/><br />');$("div.object-links",d).length!=0&&b.append('<img src="/static/icons/sidebar/link.gif"/><br />');$("div.subscription-users",d).length!=0&&b.append('<img src="/static/icons/sidebar/subscribe.gif"/><br />'); $("a.pdf-block-link",d).length!=0&&b.append('<img src="/static/icons/sidebar/export.gif"/><br />');c?d.css("display",c):(d.css("display","none"),b.css({visibility:"hidden"}))},prepare_list_actions:function(a){$(".content-list-item",a).each(function(){$("span.content-list-item-actions",$(this)).css("visibility","hidden");$(this).mouseover(function(){$("span.content-list-item-actions",$(this)).css("visibility","visible")}).mouseout(function(){$("span.content-list-item-actions",$(this)).css("visibility", "hidden")});$("span.content-list-item-actions a",$(this)).addClass("popup-link")})},put_datepicker:function(a){$("input.datepicker",a).each(function(){var a={},b=$(this).attr("initial");if(b)b=parseInt(b)*1E3,a.defaultDate=new Date(b);$(this).datepicker(a)});$("input.datetimepicker",a).each(function(){var a={stepMinute:5,hour:12,minute:0,firstDay:1},b=$(this).attr("initial");if(b)b=parseInt(b)*1E3,b=new Date(b),a.defaultDate=b,a.hour=b.getHours(),a.minute=b.getMinutes(),a.second=b.getSeconds();$(this).datetimepicker(a)})}, prepare_mass_form:function(a){$("input[type=checkbox].group-control",a).each(function(){$(this).data("form",$("ul.mass-form",a));$(this).click(function(){$("input[type=checkbox].group-"+$(this).attr("name")).attr("checked",$(this).attr("checked"));$(this).data("form").fadeTo("fast",1)})});$("ul.mass-form input[type=submit]",a).remove();$("ul.mass-form",a).each(function(){$(this).css("opacity",0.6)});$(".content-list-item input[type=checkbox], #sales_table, #reports_table",a).each(function(){$(this).data("form", $("ul.mass-form",a));$(this).click(function(){$(this).data("form").fadeTo("fast",1)})});$(".mass-form select",a).each(function(){$(this).css("opacity",0);$(this).change(function(){var a=$("span.wrap-value",$(this).parent()),b=$(this).children("option:selected");!b.val()==""&&(a.text(b.text()),b.val()=="delete"||b.val()=="delete_all"?confirm("Really delete?\n\n(This cannot be undone)")&&$(this).parent().submit():$(this).parent().submit())})});$(".mass-form label",a).each(function(){$(this).next("select").andSelf().wrapAll('<div class="wrap-class" />'); $(this).replaceWith('<span class="wrap-label">'+$(this).text()+'&nbsp;<span class="wrap-value"></span></span>')})},prepare_filter_form:function(a){$("form.content-filter-form input",a).live("change",function(){$(this).parents("form.content-filter-form").submit()});$("form.content-filter-form select",a).live("change",function(){$(this).parents("form.content-filter-form").submit()});$("form.content-filter-form :submit").hide()},prepare_popup_content:function(a){var c=a.popup_id;if($("#"+c).length){var b= $("#"+c);$("a",b).each(function(){if($(this).attr("href")&&!$(this).hasClass("popup-link")&&!$(this).hasClass("ajax-link-out")&&!$(this).attr("target")&&$(this).attr("href").substring(0,3)!="www"&&$(this).attr("href").substring(0,5)!="http:"&&$(this).attr("href").substring(0,6)!="https:"&&$(this).attr("href").substring(0,4)!="ftp:"&&$(this).attr("href").substring(0,7)!="mailto:"){$(this).attr("href").indexOf(c)==-1?$(this).data("href","/user/popup/"+c+"/url="+$(this).attr("href")):$(this).data("href", $(this).attr("href"));if($.browser.msie&&$.browser.version.substr(0,1)<7){var a=window.location.href.replace(window.location.hash,"");$(this).data("href",$(this).data("href").replace(a,"/"))}$(this).click(function(){$("#loading-status").css("display","block");url=$(this).data("href");$.ajax({url:url,dataType:"json",success:anaf.process_popup_data});return!1})}});anaf.prepare_popups(b);$("form",b).each(function(){(url=$(this).attr("action"))?url.indexOf("/user/popup/")==-1&&(url="/user/popup/"+ a.popup_id+"/url="+url):url=a.url;$(this).attr("action",url);var b={beforeSubmit:function(){$("#loading-status").css("display","block")},url:url,dataType:"json",success:anaf.process_ajax};$(this).ajaxForm(b)});anaf.showhidejs(b);anaf.prepare_ajax_links(b);anaf.prepare_comments(b);anaf.prepare_tags(b);anaf.prepare_autocomplete(b);anaf.prepare_search_duplicates(b);anaf.put_datepicker(b);anaf.prepare_mass_form(b);anaf.put_mce(b)}},process_popup_data:function(a){if(a.popup){var c= $("#"+a.popup.popup_id);if(a.popup.object){if(c.data("field")){var b=$("#"+c.data("module")),d=$("#"+c.data("field"),b);d.hasClass("autocomplete")?(d.val(a.popup.object.name),b=$("#"+d.attr("id").replace("autocomplete_",""),b),b.each(function(){$(this).val(a.popup.object.id)})):d.hasClass("duplicates")?(d.val(a.popup.object.name),b=$("#"+d.attr("id").replace("duplicates_",""),b),b.each(function(){$(this).val(a.popup.object.id)})):d.append('<option value="'+a.popup.object.id+'" selected="selected">'+ a.popup.object.name+"</option>")}else{var e=location.hash.substring(1),e=anaf.prepare_url(e),b=c.parents("div.popup-block-inner");$("#loading-status").css("display","block");b.length>0&&$(b).first().each(function(){e="/user/popup/"+$(this).attr("id")+"/url="+$(this).parent().data("link").replace("#","")});$.ajax({url:e,dataType:"json",success:anaf.process_ajax,complete:anaf.process_html})}c.parent().remove()}else a.popup.redirect?(e=location.hash.substring(1),e=anaf.prepare_url(e), b=c.parents("div.popup-block-inner"),$("#loading-status").css("display","block"),b.length>0&&$(b).first().each(function(){e="/user/popup/"+$(this).attr("id")+"/url="+$(this).parent().data("link").replace("#","")}),$.ajax({url:e,dataType:"json",success:anaf.process_ajax,complete:anaf.process_html}),c.parent().remove()):(b=c.parent().children("div.popup-title-block"),b.children("span.popup-title").html(a.popup.title),b.children("span.popup-subtitle").html(a.popup.subtitle),c.html(a.popup.content), anaf.prepare_popup_content(a.popup),c.parent().fadeIn(300),$("input:text:visible:first",c).focus())}$("#loading-status").css("display","none")},prepare_popups:function(a){$("a.popup-link",a).each(function(){$(this).hasClass("popup-link-out")||$(this).click(function(){var c=a.attr("id")+"-popup-"+$(this).attr("id")+"-"+Date.now();if($("#"+c).length)return!1;$("#loading-status").css("display","block");var b=$("<div></div>").addClass("popup-block").css("display","none").css("visibility","visible"); b.data("link",$(this).attr("href"));var d=$("<div></div>").addClass("popup-title-block");d.append($("<span></span>").addClass("popup-title"));d.append($("<span></span>").addClass("popup-subtitle"));var e=$("<div></div>").addClass("popup-link-open");e.click(function(){var a=$(this).parent().data("link");if(a)a=a.replace("#",""),window.location.hash=a,$(this).parent().remove()});var f=$("<div></div>").addClass("popup-close");f.click(function(){$("#"+c).length&&$("#"+c).parent().remove()});var g=$("<div></div>").addClass("popup-block-inner"); g.attr("id",c);$(this).attr("field")&&(g.data("field",$(this).attr("field")),g.data("module",a.attr("id")));b.append(f);b.append(e);b.append(d);b.append(g);a.append(b);d=b.parents("div.popup-block-inner");d.length>0?(d=d.first().offset(),b.position({my:"center top",at:"center top",of:$(this),collision:"flip",offset:"-"+d.left+" -"+d.top+""})):b.position({my:"left top",at:"left top",of:$(this),collision:"fit",offset:"-30 -5"});b.draggable({handle:"div.popup-title-block",opacity:0.5,addClasses:!1}); url="/user/popup/"+c+"/url="+$(this).attr("href").replace("#","");$.browser.msie&&$.browser.version.substr(0,1)<7&&(url="/user/popup/"+c+"/url=/"+$(this).attr("href").replace("#",""),b=window.location.href.replace(window.location.hash,""),url=url.replace(b,""));url=url.replace("//","/");$.ajax({url:url,dataType:"json",success:anaf.process_popup_data});return!1})})},prepare_autocomplete:function(a){$("input.autocomplete",a).each(function(){$(this).data("hidden_field",$("#id_"+$(this).attr("name").replace("autocomplete_", ""),a));$(this).autocomplete({source:$(this).attr("callback")+".json",focus:function(a,b){$(this).val(b.item.label);$(this).data("hidden_field").val(b.item.value);return!1},select:function(a,b){$(this).val(b.item.label);$(this).data("hidden_field").val(b.item.value);return!1}});$(this).change(function(){$(this).val()==""&&$(this).data("hidden_field").val("")})});$("input.multicomplete",a).each(function(){$(this).data("hidden_fields",$("#"+$(this).attr("name").replace("multicomplete_","multi_"),a)); $(this).bind("keydown",function(a){a.keyCode===$.ui.keyCode.TAB&&$(this).data("autocomplete").menu.active&&a.preventDefault()});$(this).bind("keyup",function(a){if(a.keyCode===$.ui.keyCode.BACKSPACE||a.keyCode===$.ui.keyCode.DELETE)for(var a=anaf.utils.split(this.value),c=$("input",$(this).data("hidden_fields")),e=0;e<c.length;e++){var f=$(c[e]).attr("label");$.inArray(f,a)==-1&&$(c[e]).remove()}});var c=$(this).attr("callback")+".json";$(this).autocomplete({source:function(a,d){$.getJSON(c,{term:anaf.utils.extractLast(a.term)}, d)},search:function(){if(anaf.utils.extractLast(this.value).length<2)return!1},focus:function(){return!1},select:function(a,c){var e=anaf.utils.split(this.value);e.pop();e.push(c.item.label);e.push("");var f=$(this).data("hidden_fields"),g=$("<input>");g.attr("type","hidden").attr("name",$(this).attr("name").replace("multicomplete_","")).attr("id","id_"+g.attr("name")).attr("value",c.item.value).attr("label",c.item.label);this.value=e.join(", ");f.append(g);e=anaf.utils.split(this.value); f=$("input",$(this).data("hidden_fields"));for(g=0;g<f.length;g++){var h=$(f[g]).attr("label");$.inArray(h,e)==-1&&$(f[g]).remove()}return!1}})})},prepare_search_duplicates:function(a){$("input.duplicates",a).each(function(){$(this).data("hidden_field",$("#id_"+$(this).attr("name").replace("duplicates_",""),a));$(this).autocomplete({source:$(this).attr("callback")+".json",focus:function(a,b){$(this).val(b.item.label);return!1},select:function(a,b){$(this).val(b.item.label);return!1}})})},prepare_comments:function(a){$("a.like-button", a).each(function(){$(this).click(function(){$(this).parent().submit();return!1})});$("a.comment-button",a).each(function(){$(this).click(function(){var a=$("div.comments-likes-box-"+$(this).attr("object"));a.toggle();a.css("display")!="none"&&$("textarea:visible:first",a).focus();return!1})});$("span.comments-likes-toggle",a).each(function(){$(this).click(function(){var a=$("div.comments-likes-box-"+$(this).attr("object"));a.toggle();a.css("display")!="none"&&$("textarea:visible:first",a).focus(); return!1})});$("form.like-form",a).each(function(){var a="comments-likes-box-"+$(this).attr("object");$("#"+a);$(this).attr("target",a);$(this).submit(function(){var a=$(this).attr("target"),c=$(this).parents("#"+a),a=anaf.utils.generate_id(a);c.attr("id",a);a={target:"#"+a,form:$(this).serializeObject(),expand:!0};Dajaxice.anaf.account.comments_likes(Dajax.process,a);return!1})})},prepare_tags:function(a){$("input#id_multicomplete_tags",a).each(function(){$(this).focus();$(this).focusout(function(){$(this).parent("form").submit()}); $(this).parent("form").submit(function(){var a=$(this).attr("target"),b=$(this).parents(a),a=anaf.utils.generate_id();b.attr("id",a);a={target:"#"+a,object_id:$(this).attr("object"),edit:!0,formdata:$(this).serializeObject()};Dajaxice.anaf.account.tags(Dajax.process,a);return!1})});$("span.tags-box").each(function(){$("span.tags-box-link",$(this)).css("visibility","hidden");$(this).hover(function(){$("span.tags-box-link",$(this)).css("visibility","visible")},function(){$("span.tags-box-link", $(this)).css("visibility","hidden")})})},prepare_forms:function(a){$("form",a).each(function(){if(!$(this).hasClass("like-form")&&!$(this).hasClass("tags-form")){(url=$(this).attr("action"))||(url=location.hash.substring(1));if($(this).attr("method")=="get"){$(this).attr("action",url);var a={beforeSubmit:function(a,c){var e=c.attr("action");e.indexOf("!")!=-1&&(e=e.substring(0,e.indexOf("!")));e+="!"+c.formSerialize();window.location.hash="#"+e;return!1}}}else url=anaf.prepare_url(url),a={beforeSubmit:function(){$("#loading-status").css("display", "block")},url:url,dataType:"json",success:anaf.process_ajax};$(this).ajaxForm(a)}});anaf.prepare_mass_form(a);anaf.prepare_filter_form(a);anaf.prepare_autocomplete(a);anaf.prepare_search_duplicates(a);anaf.put_datepicker(a)},prepare_dropdown_menus:function(){$("a.menu-dropdown-link").each(function(){$(this).click(function(){var a=$("#"+$(this).attr("dropdown"));$(this).addClass("menu-dropdown-link-active");a.slideDown("fast").show()});$(this).hover(function(){var a=$("#"+$(this).attr("dropdown")); $(this).addClass("menu-dropdown-link-active");a.slideDown("fast").show()});$(this).parent().hover(function(){},function(){var a=$(this).children("a.menu-dropdown-link");$(this).children("#"+a.attr("dropdown")).slideUp("fast");a.removeClass("menu-dropdown-link-active")})})},prepare_toolbar:function(){$("span.hide_toolbar").click(function(){$("#toolbar").slideToggle("fast",function(){$("#toolbar_action").fadeIn("slow")})});$("span.show_toolbar").click(function(){$("#toolbar_action").fadeOut("fast", function(){$("#toolbar").slideToggle("fast")})})}};anaf.utils={split:function(a){return a.split(/,\s*/)},extractLast:function(a){return anaf.utils.split(a).pop()},generate_id:function(a){a||(a="ajax");for(var a=a+"-"+Date.now(),c=0;$("#"+a).length>0;)a=a+"-"+c,c++;return a}}; anaf.modules={"anaf-home":{init:function(){var a={opacity:0.6,handle:"div.widget-title",connectWith:"#widget-panel-right",items:"div.widget-block",cursor:"move",update:function(){var a=$(this).attr("callback")+"?"+$(this).sortable("serialize");$.ajax({url:a})},start:function(a,b){$("#widget-panel-left").addClass("widget-panel-active");$("#widget-panel-right").addClass("widget-panel-active");b.item.addClass("widget-block-moving")},beforeStop:function(a,b){b.item.removeClass("widget-block-moving")}, stop:function(){$("#widget-panel-left").removeClass("widget-panel-active");$("#widget-panel-right").removeClass("widget-panel-active")}};$("#widget-panel-left").sortable(a);a.connectWith="#widget-panel-left";$("#widget-panel-right").sortable(a)}},"anaf-core":{init:function(){$("div.setup-module-box").length>0&&$("div.setup-module-box").each(function(){$(this).click(function(){$(this).toggleClass("setup-module-box-active");$("input",$(this)).each(function(){$(this).attr("checked",!$(this).attr("checked"))})})})}}, "anaf-projects":{timer:function(){var a=$(".projects-timeslot");a&&(a.each(function(){var a=$(this).data("start"),b=Date.now();a==null&&(a=parseInt($(this).attr("diff")),a=b-a*1E3,$(this).data("start",a));var d=(b-a)/1E3,a=Math.floor(d/3600),b=Math.floor((d/3600-a)*60),d=Math.round(((d/3600-a)*60-b)*60);a+=":";a+=b>=10?b+":":"0"+b+":";a+=d>=10?d:"0"+d;$(this).html(a)}),window.setTimeout(anaf.modules["anaf-projects"].timer,1E3))},init:function(){$(".projects-timeslot")&&this.timer();var a= $("div.ganttChart");a&&this.gantt(a)},gantt:function(a){a.each(function(){if(ganttData){$(this).ganttView({data:ganttData,behavior:{onClick:function(){},onResize:function(a){Dajaxice.anaf.projects.gantt(callback_function,{task:a.id,start:a.start.toString("yyyy-M-d"),end:a.end.toString("yyyy-M-d")})},onDrag:function(a){Dajaxice.anaf.projects.gantt(callback_function,{task:a.id,start:a.start.toString("yyyy-M-d"),end:a.end.toString("yyyy-M-d")})}}});var a=$("#module-anaf-projects");$(this).ganttView("setSlideWidth", $("td.module-content",a).width()-60);anaf.prepare_popups($(this));$(window).resize(function(){$("div.ganttChart",a).each(function(){var a=$("#module-anaf-projects");$(this).ganttView("setSlideWidth",$("td.module-content",a).width()-60)})})}})}},"anaf-reports":{init:function(){}}}; anaf.nuvius={profile:null,access_popup:!1,reload_on_profile:!0,fetch_profile:function(){$("#loading-status").css("display","block");$("#loading-status-text").html("Loading...");$.ajax({url:nuvius_profile_url,dataType:"jsonp",success:anaf.nuvius.load_profile,error:anaf.show_error})},check_profile:function(a){a?a.key_valid&&(a.username?$("#nuvius-username").html(a.username):$("#nuvius-username").html("Anonymous User"),anaf.nuvius.reload_on_profile&&anaf.do_ajax()):anaf.nuvius.profile&& (a=nuvius_profile_check_url,a+="?nuvius_id="+anaf.nuvius.profile.id+"&profile_key="+anaf.nuvius.profile.key,$.ajax({url:a,dataType:"json",success:anaf.nuvius.check_profile,error:anaf.show_error}))},load_profile:function(a){$("#loading-status").css("display","none");if(a.profile)!a.profile.access_granted&&anaf.nuvius.access_popup?($.colorbox({href:a.profile.access_url,width:"80%",height:"80%",iframe:!0,overlayClose:!1,onClosed:anaf.nuvius.fetch_profile}),anaf.nuvius.access_popup= !1):(anaf.nuvius.profile=a.profile,anaf.nuvius.check_profile())},fetch_access:function(){anaf.nuvius.access_popup=!0;anaf.nuvius.fetch_profile()},close_iframe:function(){$.colorbox.close()}}; $(function(){$(window).hashchange(anaf.do_ajax);$(window).hashchange();anaf.prepare_dropdown_menus();anaf.prepare_toolbar();anaf.convert_links();anaf.prepare_ajax_links();$(".menu-item a").each(function(){$(this).click(function(){$(this).hasClass("active")&&$(this).attr("href")==window.location.hash&&$(window).hashchange()})});$("#perspective_switch").each(function(){(url=$(this).attr("action"))||(url=location.hash.substring(1));url=anaf.prepare_url(url);var a={beforeSubmit:function(){$("#loading-status").css("display", "block")},url:url,dataType:"json",success:anaf.process_ajax};$(this).ajaxForm(a);$(this).children("select").change(function(){$("#perspective_switch").submit()})});$("form#search_form").each(function(){(url=$(this).attr("action"))||(url=location.hash.substring(1));$(this).attr("action",url);$(this).ajaxForm({beforeSubmit:function(a,c){var b=c.attr("action");b+="!"+c.formSerialize();window.location.hash="#"+b;return!1}})});$(".module-block").data("title",document.title);$(".module-block").each(function(){doc= $(this);$("form").length&&(anaf.prepare_forms(doc),anaf.prepare_comments(doc),$("textarea").length&&anaf.put_mce(doc),anaf.put_datepicker(doc),anaf.prepare_forms(doc));anaf.prepare_tags();anaf.prepare_slider_sidebar(doc);anaf.prepare_list_actions(doc);anaf.prepare_popups(doc);anaf.showhidejs(doc);module_name=$(this).attr("id").substring(7);anaf.prepare_module_stuff(module_name)})});
