...
//		this.element.find( ".top-menu" )
	//		.wrap('<li />');
			
//		this.element.find( ".module-top-menu-inline" )
	//		.wrap('<ul data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all ui-controlgroup ui-controlgroup-vertical ui-shadow" role="listbox" />');
		
	
		$elem.find( ".top-menu" )
			.buttonMarkup();
		
		$elem.find( ".sidebar-link" )
			.buttonMarkup();
			
		$elem.find( ".module-sidebar" )
			.attr("valign", "top")
			
		$elem.find( ".module-content" )
			.attr("valign", "top")
			
		$elem.find( ".module-sidebar-right" )
			.attr("style", "display:none");
			
		$elem.find( ".title" )
			.attr("style", "display:none")
			
		$elem.find( ".subtitle-block" )
			.attr("style", "display:none")
			
		$elem.find( ".sidebar-header" )
			.attr("style", "display:none")
		
		$elem.find( ".help-block-link" )
			.attr("style", "display:none")	
		
		$elem.find( ".mass-form" )
			.attr("style", "display:none")
			
		$elem.find( ".group-link" )
			.attr("style", "display:none")
			
		$elem.find( ".author-link" )
			.attr("style", "display:none")
			
		$elem.find( ".group-control" )
			.attr("style", "display:none")
			
		$elem.find('[data-role="collapsible"]')
			.attr("data-theme", "a")
			
			
//		this.element.find( ".module-content-inner" )
	//		.wrapInner('<ul data-role="listview" data-inset="true" data-theme="d" />')
			
//		this.element.find( ".content-list-item" )
	//		.wrap('<li />');
	...
	$( "a" ).live( "click", function(event) {
		...
		if( external || !$.mobile.ajaxLinksEnabled ){
			...
			if( target ){
				...
				location.href = href.replace('/m', ''); //anaf
			}
		}
		else {	
			//use ajax
